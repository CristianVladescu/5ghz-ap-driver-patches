...
```
git clone https://github.com/CristianVladescu/ath-user-regd
sed -i 's/<CountryCode to use>/CTRY_ROMANIA' ath-user-regd/ath.patch
```
Compile ath module:
```
cd linux-5.10.140
patch -p1 < ../ath-user-regd/ath.patch
